...
\hypertarget{memtrace_8h_source}{}\label{memtrace_8h_source}\index{src/memtrace.h@{src/memtrace.h}}
...
\DoxyCodeLine{00164\ \textcolor{preprocessor}{\#ifdef\ MEMTRACE\_CPP}}
\DoxyCodeLine{00165\ \ \ \ \ \textcolor{keyword}{namespace\ }std\ \{}
\DoxyCodeLine{00166\ \ \ \ \ \ \ \ \ \textcolor{keyword}{typedef}\ void\ (*new\_handler)();}
\DoxyCodeLine{00167\ \}}
\DoxyCodeLine{00168\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00169\ }
\DoxyCodeLine{00170\ \textcolor{preprocessor}{\#ifdef\ MEMTRACE\_C}}
\DoxyCodeLine{00171\ START\_NAMESPACE}
\DoxyCodeLine{00172\ \textcolor{preprocessor}{\ \ \ \ \#undef\ malloc}}
\DoxyCodeLine{00173\ \textcolor{preprocessor}{\ \ \ \ \#define\ malloc(size)\ TRACEC(traced\_malloc)(size,\#size,\_\_LINE\_\_,\_\_FILE\_\_)}}
\DoxyCodeLine{00174\ \ \ \ \ \textcolor{keywordtype}{void}\ *\ traced\_malloc(\textcolor{keywordtype}{size\_t}\ size,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *size\_txt,\ \textcolor{keywordtype}{int}\ line,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ file);}
\DoxyCodeLine{00175\ }
\DoxyCodeLine{00176\ \textcolor{preprocessor}{\ \ \ \ \#undef\ calloc}}
\DoxyCodeLine{00177\ \textcolor{preprocessor}{\ \ \ \ \#define\ calloc(count,size)\ TRACEC(traced\_calloc)(count,\ size,\ \#count"{},"{}\#size,\_\_LINE\_\_,\_\_FILE\_\_)}}
\DoxyCodeLine{00178\ \ \ \ \ \textcolor{keywordtype}{void}\ *\ traced\_calloc(\textcolor{keywordtype}{size\_t}\ count,\ \textcolor{keywordtype}{size\_t}\ size,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *size\_txt,\ \textcolor{keywordtype}{int}\ line,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ file);}
\DoxyCodeLine{00179\ }
\DoxyCodeLine{00180\ \textcolor{preprocessor}{\ \ \ \ \#undef\ free}}
\DoxyCodeLine{00181\ \textcolor{preprocessor}{\ \ \ \ \#define\ free(p)\ TRACEC(traced\_free)(p,\ \#p,\_\_LINE\_\_,\_\_FILE\_\_)}}
\DoxyCodeLine{00182\ \ \ \ \ \textcolor{keywordtype}{void}\ traced\_free(\textcolor{keywordtype}{void}\ *\ p,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *size\_txt,\ \textcolor{keywordtype}{int}\ line,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ file);}
\DoxyCodeLine{00183\ }
\DoxyCodeLine{00184\ \textcolor{preprocessor}{\ \ \ \ \#undef\ realloc}}
\DoxyCodeLine{00185\ \textcolor{preprocessor}{\ \ \ \ \#define\ realloc(old,size)\ TRACEC(traced\_realloc)(old,size,\#size,\_\_LINE\_\_,\_\_FILE\_\_)}}
\DoxyCodeLine{00186\ \ \ \ \ \textcolor{keywordtype}{void}\ *\ traced\_realloc(\textcolor{keywordtype}{void}\ *\ old,\ \textcolor{keywordtype}{size\_t}\ size,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *size\_txt,\ \textcolor{keywordtype}{int}\ line,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ file);}
\DoxyCodeLine{00187\ }
\DoxyCodeLine{00188\ \ \ \ \ \textcolor{keywordtype}{void}\ mem\_dump(\textcolor{keywordtype}{void}\ \textcolor{keyword}{const}\ *mem,\ \textcolor{keywordtype}{size\_t}\ size,\ FILE*\ fp\ =\ stdout);}
\DoxyCodeLine{00189\ }
\DoxyCodeLine{00190\ }
\DoxyCodeLine{00191\ END\_NAMESPACE}
\DoxyCodeLine{00192\ \textcolor{preprocessor}{\#endif}\textcolor{comment}{/*MEMTRACE\_C*/}\textcolor{preprocessor}{}}
\DoxyCodeLine{00193\ }
\DoxyCodeLine{00194\ \textcolor{preprocessor}{\#ifdef\ MEMTRACE\_CPP}}
\DoxyCodeLine{00195\ START\_NAMESPACE}
\DoxyCodeLine{00196\ \textcolor{preprocessor}{\ \ \ \ \#undef\ set\_new\_handler}}
\DoxyCodeLine{00197\ \textcolor{preprocessor}{\ \ \ \ \#define\ set\_new\_handler(f)\ TRACEC(\_set\_new\_handler)(f)}}
\DoxyCodeLine{00198\ \ \ \ \ \textcolor{keywordtype}{void}\ \_set\_new\_handler(std::new\_handler\ h);}
\DoxyCodeLine{00199\ }
\DoxyCodeLine{00200\ \ \ \ \ \textcolor{keywordtype}{void}\ set\_delete\_call(\textcolor{keywordtype}{int}\ line,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ file);}
\DoxyCodeLine{00201\ END\_NAMESPACE}
\DoxyCodeLine{00202\ }
\DoxyCodeLine{00203\ \textcolor{keywordtype}{void}\ *\ \textcolor{keyword}{operator}\ \textcolor{keyword}{new}(\textcolor{keywordtype}{size\_t}\ size,\ \textcolor{keywordtype}{int}\ line,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ file)\ THROW\_BADALLOC;}
\DoxyCodeLine{00204\ \textcolor{keywordtype}{void}\ *\ \textcolor{keyword}{operator}\ \textcolor{keyword}{new}[](\textcolor{keywordtype}{size\_t}\ size,\ \textcolor{keywordtype}{int}\ line,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ file)\ THROW\_BADALLOC;}
\DoxyCodeLine{00205\ \textcolor{keywordtype}{void}\ *\ \textcolor{keyword}{operator}\ \textcolor{keyword}{new}(\textcolor{keywordtype}{size\_t}\ size)\ THROW\_BADALLOC;}
\DoxyCodeLine{00206\ \textcolor{keywordtype}{void}\ *\ \textcolor{keyword}{operator}\ \textcolor{keyword}{new}[](\textcolor{keywordtype}{size\_t}\ size)\ THROW\_BADALLOC;}
\DoxyCodeLine{00207\ \textcolor{keywordtype}{void}\ \textcolor{keyword}{operator}\ \textcolor{keyword}{delete}(\textcolor{keywordtype}{void}\ *\ p)\ \ THROW\_NOTHING;}
\DoxyCodeLine{00208\ \textcolor{keywordtype}{void}\ \textcolor{keyword}{operator}\ \textcolor{keyword}{delete}[](\textcolor{keywordtype}{void}\ *\ p)\ THROW\_NOTHING;}
\DoxyCodeLine{00209\ }
\DoxyCodeLine{00210\ \textcolor{preprocessor}{\#if\ \_\_cplusplus\ >=\ 201402L}}
\DoxyCodeLine{00211\ \textcolor{comment}{//\ sized\ delete\ miatt:\ http://www.open-\/std.org/jtc1/sc22/wg21/docs/papers/2013/n3536.html}}
\DoxyCodeLine{00212\ \textcolor{keywordtype}{void}\ \textcolor{keyword}{operator}\ \textcolor{keyword}{delete}(\textcolor{keywordtype}{void}\ *\ p,\ size\_t)\ \ THROW\_NOTHING;}
\DoxyCodeLine{00213\ \textcolor{keywordtype}{void}\ \textcolor{keyword}{operator}\ \textcolor{keyword}{delete}[](\textcolor{keywordtype}{void}\ *\ p,\ size\_t)\ THROW\_NOTHING;}
\DoxyCodeLine{00214\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00215\ }
\DoxyCodeLine{00216\ \textcolor{comment}{/*\ Visual\ C++\ 2012\ miatt\ kell,\ mert\ háklis,\ hogy\ nincs\ megfelelő\ delete,\ bár\ senki\ sem\ használja\ */}}
\DoxyCodeLine{00217\ \textcolor{keywordtype}{void}\ \textcolor{keyword}{operator}\ \textcolor{keyword}{delete}(\textcolor{keywordtype}{void}\ *p,\ int,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *)\ THROW\_NOTHING;}
\DoxyCodeLine{00218\ \textcolor{keywordtype}{void}\ \textcolor{keyword}{operator}\ \textcolor{keyword}{delete}[](\textcolor{keywordtype}{void}\ *p,\ int,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *)\ THROW\_NOTHING;}
\DoxyCodeLine{00219\ }
\DoxyCodeLine{00220\ }
\DoxyCodeLine{00221\ \textcolor{preprocessor}{\#define\ new\ new(\_\_LINE\_\_,\ \_\_FILE\_\_)}}
\DoxyCodeLine{00222\ \textcolor{preprocessor}{\#define\ delete\ memtrace::set\_delete\_call(\_\_LINE\_\_,\ \_\_FILE\_\_),delete}}
\DoxyCodeLine{00223\ }
\DoxyCodeLine{00224\ \textcolor{preprocessor}{\#ifdef\ CPORTA}}
\DoxyCodeLine{00225\ \textcolor{preprocessor}{\#define\ system(...)\ \ }\textcolor{comment}{//\ system(\_\_VA\_ARGS\_\_)}}
\DoxyCodeLine{00226\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00227\ }
\DoxyCodeLine{00228\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*MEMTRACE\_CPP*/}\textcolor{preprocessor}{}}
\DoxyCodeLine{00229\ }
\DoxyCodeLine{00230\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*FROM\_MEMTRACE\_CPP*/}\textcolor{preprocessor}{}}
\DoxyCodeLine{00231\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00232\ \textcolor{preprocessor}{\#pragma\ message\ (\ "{}MEMTRACE\ NOT\ DEFINED"{}\ )}}
\DoxyCodeLine{00233\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*MEMTRACE*/}\textcolor{preprocessor}{}}
\DoxyCodeLine{00234\ }
\DoxyCodeLine{00235\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*MEMTRACE\_H*/}\textcolor{preprocessor}{}}
